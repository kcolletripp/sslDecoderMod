          ...
          <form class="form-horizontal">
            ...
            <fieldset>
              <div class="form-group">
                ...
                <div class="col-md-5">
                  <input id="host" name="host" type="text" placeholder="easyweb.td.com (or Host:IP to test a specific hostname on an IP)" autofocus="autofocus" class="form-control input-md" >
                </div>
